              ...
              <div>
                ...
                <div>
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <a href={`https://wa.me/+919966099152?text=${encodeURI('Hello, I am interested in your product: ' + productData.name)}`} target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text={`${productData.category.name}`} />
                      </div>
                    </div>
                    <div className="mb-5">
